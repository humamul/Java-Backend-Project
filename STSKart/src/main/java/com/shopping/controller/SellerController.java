...
//	private PrService ps;
	...
	public ResponseEntity<Seller> createAccount(@Valid @RequestBody Seller admin) throws AdminException{
	...
	public ResponseEntity<Seller> deleteAccount(@RequestParam String email,@RequestParam String password,@RequestParam(required = false) String Uuid) throws AdminException{
	...
	public ResponseEntity<SellerProducts> addProd(@RequestBody SellerProducts product ,@RequestParam Integer adminId) throws AdminException{
